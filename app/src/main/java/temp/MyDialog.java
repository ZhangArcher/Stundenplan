...
//	private EditText course_time1,course_time2;
	...
	public void add(final int day,final int n){
		...
		.setTitle("add Information of lesson")
		.setView(view)
		.setPositiveButton("ok",new OnClickListener(){
			...
			public void onClick(DialogInterface arg0, int arg1) {
				if(!(s1=course_name.getText().toString()).equals("")) s1="lesson: "+s1;
				if(!(s2=course_address.getText().toString()).equals("")) s2="place: "+s2;
				if(!(s3=course_teacher.getText().toString()).equals("")) s3="Professor: "+s3;
				if(!(s4=course_week.getText().toString()).equals("")) s4="week: "+s4;
				...
				if((s5=course_count.getText().toString()).equals("")||s1.equals("")) {
					Toast.makeText(context, "please give a right lesson and time！", 3000).show();
					return;
				}
				else {
	...
	public void modify(final int day,final int n){
		...
		builder=new AlertDialog.Builder(context)
		.setIcon(R.drawable.ic_launcher)
		.setTitle("change Information of lesson")
		.setView(view)
		.setPositiveButton("ok",new OnClickListener(){
